...
const Header = () => {
  ...
  return (
    <header
      id="header"
      className={`fixed z-10 -translate-y-[1px] md:z-20 flex items-center justify-center w-screen pt-6 pb-4 text-white font-[manrope] transition-all duration-500 ${bgOpacity}`}
    >
